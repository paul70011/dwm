...
static Key keys[] = {
	...
	{ 0,                            XF86XK_AudioPlay,            spawn,                SHCMD("playerctl -p playerctld play-pause") },
	{ 0,                            XF86XK_AudioPrev,            spawn,                SHCMD("playerctl -p playerctld previous") },
	{ 0,                            XF86XK_AudioNext,            spawn,                SHCMD("playerctl -p playerctld next") },
